...
package com.zenith.stayfit.ui.supplements.data.datasource
...
object Supplements {
    fun getAllSupplements(): ArrayList<Supplement> {
        ...
        val allSupplement = ArrayList<Supplement>()
        allSupplement.add(
            Supplement(
                "Creatine",
                "Creatine is probably the single best supplement for muscle gain. Many studies have confirmed that it can help increase muscle mass.",
                "Creatine is a molecule that’s produced naturally in your body. It provides energy for your muscles and other tissues.Taking it as a dietary supplement can increase muscle creatine content by up to 40% beyond its normal levels"
            )
        )
        allSupplement.add(
            Supplement(
                "Protein Supplements",
                "Consuming enough protein is absolutely essential for optimal muscle gain. However, if you are getting enough protein in your diet, taking a protein supplement is unnecessary.",
        ...
        allSupplement.add(
            Supplement(
                "Beta-Alanine",
                "Beta-alanine is an amino acid that can improve exercise performance. Some evidence shows that it may also help increase muscle mass in response to exercise",
